...
x = audioinfo(filepath);
[input_data, sample_freq] = audioread(filepath);
bits_per_sample = x.BitsPerSample;
% display sample rate
...
if (sample_freq ~= desired_sample_rate)
    ...
    audiowrite(newpath, input_data, desired_sample_rate, 'BitsPerSample', desired_bps);
