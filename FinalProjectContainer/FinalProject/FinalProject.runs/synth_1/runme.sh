...
HD_PWD='C:/Users/Aaron Wubshet/Desktop/6.111_Final_Project/FinalProjectContainer/FinalProject/FinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_project.vds -m64 -mode batch -messageDb vivado.pb -notrace -source final_project.tcl
