...
HD_PWD='C:/Users/Aaron Wubshet/Desktop/6.111_Final_Project/FinalProjectContainer/FinalProject/FinalProject.runs/clk_manager_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_manager.vds -m64 -mode batch -messageDb vivado.pb -notrace -source clk_manager.tcl
