...
#
# Generated by export_simulation on Fri Dec 08 16:42:47 -0500 2017
#
################################################################################
...
switch to the './xy_bin.sh' script.
...
./xy_bin.sh -noclean_files

For more information on the script, please type './xy_bin.sh -help'.
