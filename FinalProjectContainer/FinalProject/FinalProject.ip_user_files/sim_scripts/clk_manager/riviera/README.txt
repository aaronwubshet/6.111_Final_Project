...
#
# Generated by export_simulation on Fri Dec 08 16:35:39 -0500 2017
#
################################################################################
...
switch to the './clk_manager.sh' script.

./clk_manager.sh -reset_run
...
./clk_manager.sh -noclean_files

For more information on the script, please type './clk_manager.sh -help'.
