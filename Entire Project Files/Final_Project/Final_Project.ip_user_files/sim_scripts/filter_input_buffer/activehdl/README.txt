...
#
# Generated by export_simulation on Mon Nov 20 22:46:10 -0500 2017
#
################################################################################
...
switch to the './filter_input_buffer.sh' script.

./filter_input_buffer.sh -reset_run
...
./filter_input_buffer.sh -noclean_files

For more information on the script, please type './filter_input_buffer.sh -help'.
