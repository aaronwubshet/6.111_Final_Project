...
#
# Generated by export_simulation on Fri Nov 17 21:16:52 -0500 2017
#
################################################################################
...
switch to the './JW_BRAM_COLOR.sh' script.

./JW_BRAM_COLOR.sh -reset_run
...
./JW_BRAM_COLOR.sh -noclean_files

For more information on the script, please type './JW_BRAM_COLOR.sh -help'.
