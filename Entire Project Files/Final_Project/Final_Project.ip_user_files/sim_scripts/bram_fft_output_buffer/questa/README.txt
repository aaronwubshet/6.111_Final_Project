...
#
# Generated by export_simulation on Fri Nov 17 16:45:03 -0500 2017
#
################################################################################
...
switch to the './bram_fft_output_buffer.sh' script.

./bram_fft_output_buffer.sh -reset_run
...
./bram_fft_output_buffer.sh -noclean_files

For more information on the script, please type './bram_fft_output_buffer.sh -help'.
