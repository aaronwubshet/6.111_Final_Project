...
HD_PWD='C:/Users/Wings/Desktop/WingsFinalProject/WingsFinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log debug.vdi -applog -m64 -messageDb vivado.pb -mode batch -source debug.tcl -notrace
