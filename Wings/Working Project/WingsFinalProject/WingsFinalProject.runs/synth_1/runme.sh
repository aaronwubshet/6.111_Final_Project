...
HD_PWD='C:/Users/Wings/Desktop/WingsFinalProject/WingsFinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debug.vds -m64 -mode batch -messageDb vivado.pb -notrace -source debug.tcl
